...
local function vapeGithubRequest(scripturl)
	if not isfile("vape/"..scripturl) then
		...
		suc, res = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/114S14/VoidwareBakup/main/"..scripturl, true) end)
			...
			local teleportScript = [[
				...
				if shared.VapeDeveloper or shared.VoidDev then
					if isfile('vape/NewMainScript.lua') then
						...
						loadstring(game:HttpGet("https://raw.githubusercontent.com/114S14/vapevoidware/main/NewMainScript.lua", true))()
					end
				else
					loadstring(game:HttpGet("https://raw.githubusercontent.com/114S14/vapevoidware/main/NewMainScript.lua", true))()
				end
